...
<template>
  <div id="bBindShop">
      ...
      <el-table border ref="multipleTable" size="mini" :data="businessDetails" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column align="center" prop="chexiaoTime" label="撤销时间" width="150">
          <template slot-scope="scope">
              <div>{{scope.row.chexiaoTime | dateParse}}</div>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="reason" label="撤销原因" width="80"></el-table-column>
