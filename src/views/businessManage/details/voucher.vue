...
<template>
  <div id="bBindShop">
      ...
      <el-table border ref="multipleTable" size="mini" :data="businessDetails" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column align="center" prop="id" label="充值id"></el-table-column>
        <el-table-column align="center" prop="money" label="充值金额"></el-table-column>
        <el-table-column align="center" prop="bank" label="收款银行" width="150"></el-table-column>

        <el-table-column align="center" prop="commitTime" label="充值时间" width="250">
