...
<template>
  <div id="bBindShop">
      ...
      <el-table border ref="multipleTable" size="mini" :data="businessDetails" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column align="center" prop="bussinessDeposit" label="任务类型">
          <template slot-scope="scope">
        ...
        <!-- <el-table-column align="center" prop="orderTime" label="放单时间" width="200">
          <template slot-scope="scope">
              <div>{{scope.row.orderTime | dateParse}}</div>
          </template>
        </el-table-column> -->
