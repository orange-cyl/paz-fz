...
<template>
  <div id="waitOrder">
    <div id="orderManage">
    <div class="totalTitle">已撤销订单</div>
    <div class="orderManage-option">
     
      <div class="searchOption">
        <div>
          <el-date-picker size='mini' v-model="searchObj.searchTime" type="daterange" value-format="yyyy-MM-dd" range-separator="~" start-placeholder="撤销时间" end-placeholder="撤销时间"></el-date-picker>
        </div>
        <div>
       ...
       <!--  <div>
        ...
        <div>
          <el-input size="mini" v-model="searchObj.taobaoOrderId" placeholder="淘宝单号" clearable></el-input>
        </div>
        <div>
    ...
    <div class="orderManage-table">
      ...
      <!--  <el-table-column align="center" prop="jiedanTime" label="接单时间"  width="200">
        ...
        <el-table-column align="center" prop="chexiaoTime" label="撤销时间"  width="200">
          <template slot-scope="scope">
            <span>{{scope.row.chexiaoTime | dateParse}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" prop="reason" label="撤销原因"></el-table-column>
        <el-table-column align="center" prop="canceler" label="撤销人"></el-table-column>    
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    // ...mapMutations(['alterTaskDetailsId','alterSubStationDetailsId','']),
  ...
  this.getOrderData(obj).then(r=>{
    ...
    loadAllOrder(){
       let obj={ 
        ...
        cancelBeginTime:this.searchObj.searchTime?config.passToStartDate(this.searchObj.searchTime[0]):'',
        cancelEndTime:this.searchObj.searchTime?config.passToEndDate(this.searchObj.searchTime[1]):'',
         }   
      //   for(let key in obj){
    ...
    toOrderDetails(row){
      ...
      //     }
      //    }  
      //    this.getBusinessManage(obj1).then(r=>{
      // })
      //    let obj={
      //     params:{
      //     page: 0,
