...
<template>
  <div id="bBindShop">
      ...
      <el-table border ref="multipleTable" size="mini" :data="businessDetails" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column align="center" prop="id" label="时间" width=""></el-table-column>

        

        <el-table-column align="center" prop="manager.telephone" label="类型" ></el-table-column>
        <el-table-column align="center" prop="manager.qq" label="订单ID"></el-table-column>
        <el-table-column align="center" prop="historyOrderCount" label="分成金额"></el-table-column>
        <el-table-column align="center" prop="finishedOrderCount" label="账户余额"></el-table-column>
