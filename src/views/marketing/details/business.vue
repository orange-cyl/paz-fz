...
<template>
  <div id="bBindShop">
      ...
      <el-table border ref="multipleTable" size="mini" :data="businessDetails" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column align="center" prop="id" label="商家ID" width=""></el-table-column>

        

        <el-table-column align="center" prop="manager.telephone" label="手机号" ></el-table-column>
        <el-table-column align="center" prop="manager.qq" label="QQ"></el-table-column>
        <el-table-column align="center" prop="historyOrderCount" label="累计放单"></el-table-column>
        <el-table-column align="center" prop="finishedOrderCount" label="已完成订单"></el-table-column>
